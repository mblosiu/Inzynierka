          ...
          <div>
            ...
            >
              <v-row>
                            ...
                            <v-list-item>
                              ...
                              >
                                <template v-slot:activator="{ on, attrs }">
                                  <div
                                    v-if="
                                      user.settings.messages_privacy ==
                                      'everybody'
                                    "
                                  >
                                    <v-btn
                ...
                <v-col cols="4">
                  <v-avatar class="ma-3 mr-5" size="125" tile>
                    <v-img
                      class="white--text align-end"
                      :src="getUrl(user.profile_picture)"
                      aspect-ratio="1"
...
export default {
  ...
  methods: {
    ...
    getUserImages() {
      axios
        .get(
          "https://elove.ml:8000/api/user/users/" +
    ...
    likeUser() {
      ...
      axios
        .post(
          "https://elove.ml:8000/api/user/create-like",
    ...
    dislikeUser() {
      const config = {};
      axios
        .delete("https://elove.ml:8000/api/user/delete-like", {
          headers: {
            Authorization: "Token " + localStorage.getItem("user-token"),
          },
          data: {
    ...
    getUserLikes() {
      axios
        .get(
          "https://elove.ml:8000/api/user/get-users-are-liked/" +
            this.$route.params.pk,
          {
            params: {},
            headers: {
